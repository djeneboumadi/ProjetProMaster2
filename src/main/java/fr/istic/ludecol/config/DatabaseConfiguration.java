package fr.istic.ludecol.config;
...
@Configuration
@EnableJpaRepositories("fr.istic.ludecol.repository")
...
public class DatabaseConfiguration implements EnvironmentAware {
    ...
    @ConditionalOnMissingClass(name = "fr.istic.ludecol.config.HerokuDatabaseConfiguration")
