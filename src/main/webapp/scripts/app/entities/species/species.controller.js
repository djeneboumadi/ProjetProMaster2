...
angular.module('ludecolApp')
    .controller('SpeciesController', function ($scope, Species, Tag) {
        $scope.speciess = [];
        ...
        $scope.clear = function () {
            $scope.species = {id_species: null, name: null, category: null, description: null, picture_spe: null, is_in_encyclo: null, id: null};
        };
    });
