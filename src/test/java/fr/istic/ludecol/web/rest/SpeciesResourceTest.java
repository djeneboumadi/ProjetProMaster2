...
public class SpeciesResourceTest {
    ...
    private static final String DEFAULT_PICTURE_SPE = "SAMPLE_TEXT";
    private static final String UPDATED_PICTURE_SPE = "UPDATED_TEXT";
    ...
    public void initTest() {
        ...
        species.setPicture_spe(DEFAULT_PICTURE_SPE);
    ...
    public void createSpecies() throws Exception {
        ...
        assertThat(testSpecies.getPicture_spe()).isEqualTo(DEFAULT_PICTURE_SPE);
    ...
    public void getAllSpeciess() throws Exception {
        ...
        restSpeciesMockMvc.perform(get("/api/speciess"))
                ...
                .andExpect(jsonPath("$.[0].picture_spe").value(DEFAULT_PICTURE_SPE.toString()))
    ...
    public void getSpecies() throws Exception {
        ...
        restSpeciesMockMvc.perform(get("/api/speciess/{id}", species.getId()))
            ...
            .andExpect(jsonPath("$.picture_spe").value(DEFAULT_PICTURE_SPE.toString()))
    ...
    public void updateSpecies() throws Exception {
        ...
        species.setPicture_spe(UPDATED_PICTURE_SPE);
        ...
        assertThat(testSpecies.getPicture_spe()).isEqualTo(UPDATED_PICTURE_SPE);
